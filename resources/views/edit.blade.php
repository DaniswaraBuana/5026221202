	...
	<form action="/pegawai/update" method="post">
        ...
        <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="umur" class="form-control" id="umur" required="required" value="{{ $p->pegawai_umur }}">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                   <input type="text" name="alamat" class="form-control" id="alamat" required="required" {{ $p->pegawai_alamat }}>
                </div>
          </div>
		 <br/>
         <div class="row mb-3">
